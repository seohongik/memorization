...
/**스코프 체인 => 스코프 :: 전역공간을 제외하면 오직 함수에 의해서만 스코프가 생성
 * 식별자의 유효범위를 안에서부터 바깥으로 차례로 검색해 나가는 것을 스코프 체인 이라고 함  (연결리스트(linkedList) 형태 :: 참조시점이 외부시점)
 * 
 * 가장 가까운 요소부터 차례대로 접근할 수 있고 다른 순서로 접근하는 것은 불가능 
 * 
*/
