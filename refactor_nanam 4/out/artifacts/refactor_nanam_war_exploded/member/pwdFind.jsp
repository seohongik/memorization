...
<c:set var="flag" value="${requestScope.findFlag}"/>
	...
	function clickFindBtn(){
		...
		$.ajax({
			...
			success: function (data) {
				...
				$("#USER_FIND_WHAT").val(data.USER_PWD);
...
<div id="allWrap">
		<ul>
			<li style="width: 120px; height: 40px; text-align:center; box-sizing: border-box; padding: 10px;  background-color: #00c5aa; margin: 30px auto; ">비밀번호찾기</li>
		</ul>
	<div id="allFindLoginWrap" >
		...
		<div id="allFindLogin" style="padding-left: 55px">
			...
			<input type="button" id="searchBtn" value="비밀번호찾기" onclick = "clickFindBtn()"/>
			<ul>
